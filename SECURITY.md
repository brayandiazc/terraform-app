...
Este documento describe cómo reportar vulnerabilidades en **terraform-app** y qué prácticas de seguridad seguimos en el repositorio.
...
| Releases / tags         | Solo la última versión mayor  |
...
- Fija las versiones de los _providers_ con `.terraform.lock.hcl` versionado y revisa los cambios de versión.
