...
agradecerá tener documentada. Ejemplos: elegir un backend de estado, definir la
estrategia de módulos, adoptar un patrón de organización.
...
| [0002](0002-adopt-project-template.md)        | Adoptar la plantilla de documentación    | Aceptada |
