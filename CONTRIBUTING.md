...
¡Gracias por tu interés en contribuir a **terraform-app**! Esta guía describe el flujo de trabajo, los estándares de código y el proceso de Pull Requests.
...
- Formatea siempre el HCL con `terraform fmt` antes de commitear.

### Nombrado

- Sigue las convenciones idiomáticas de **HCL / Terraform** (recursos y variables en `snake_case`, nombres de recurso descriptivos).
...
- Valida y formatea cada cambio de configuración antes de abrir el PR:
